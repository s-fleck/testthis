...
Testthis also provides the experimental feature `get_test_coverage()`. This
displays the test coverage of a package, but in contrast the 
[covr](https://github.com/r-lib/covr) the test coverage is not calculated 
automatically. To work, `get_test_coverage()` requires you to put special
comment tags in your test-source files. Please see the package vignette
for examples.
