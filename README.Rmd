...
testthis is CRAN-ready, but not yet on CRAN. This is beause it depends on the
r-lib package usethis, which is also not yet on CRAN. You can install testthis
like this:
