#' Test this file
#'
#' This is a convenience function to run testthat tests in a single .R file.
#' If the file currently open in the Rstudio editor is called \code{my_function.R},
#' \code{test_this()} calls \code{testthat::test_file()} on "tests/testthat/test_my_function.R".
